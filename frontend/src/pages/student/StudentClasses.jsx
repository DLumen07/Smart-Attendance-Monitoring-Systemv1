...
import { ArrowUpRight, BookOpen, Plus, RefreshCcw } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-transparent w-full mx-auto p-4 md:p-5 lg:p-6 font-sans text-[#111]">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1.95fr] gap-4 lg:gap-5">
          <div className="bg-white rounded-[22px] p-5 border border-black/5 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
            <h3 className="text-[16px] font-semibold text-[#111]">Join a Class</h3>
            <p className="text-[13px] text-[#666] mt-1">Enter the instructor join code.</p>
